...
cursor.execute('INSERT INTO Venue (id, completed) VALUES (%s, %s);', (1, True))

SQL = 'INSERT INTO Venue (id, completed) VALUES (%(id)s, %(completed)s);'
data=[{
    "city": "San Francisco",
    "state": "CA",
    "venues": [{
...
cursor.execute('INSERT INTO Artist(id, completed) VALUES (%s, %s);', (1, True))

SQL = 'INSERT INTO Artist (id, completed) VALUES (%(id)s, %(completed)s);'
data=[{
    "id": 4,
    "name": "Guns N Petals",
  }, {
